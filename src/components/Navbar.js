...
const Navbar = () => {
    ...
    const searchVideo = () => {
        ...
        setInput("");//for delete after the search
    }
    const toggleHandler = () => {
    ...
    // when when input is change that showsuggestion is called
    useEffect(() => {
        ...
        <div className="flex fixed top-0 justify-center items-center w-[100%] z-10 bg-white" >
            <div className="flex w-[96%] py-3 justify-between items-center">
                ...
                <div className="flex w-[40%] items-center">
                    ...
                    {/* for dispaly dropdown */}
                    {
                        (suggestion && searchSuggestion.length != 0) &&
                        <div className="absolute top-3 z-50 w-[30%] py-5 bg-white shadow-lg mt-12 rounded-lg border-gray-200">
                            <ul>
                                {
